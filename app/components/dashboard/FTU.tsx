    ...
    <div className="relative">
      ...
      <div className="relative">
        <div
          ...
          } py-4 px-5 2xl:p-4 mt-2 max-w-[835px] 2xl:max-w-[80%] rounded-[16px]`}
        >
          ...
          <h2 className="font-semibold 2xl:text-xl font-Poppins">
            Setup Guide
          </h2>
          ...
          >
            ...
            flex items-center justify-center"
              ...
              <div className="flex-1">
                <h3 className="text-matte text-sm 2xl:text-lg font-medium">
