    ...
    <div>
      ...
      >
        <div className="flex justify-between items-center">
          <h3 className="text-white font-Poppins text-[0.9rem] font-medium">
            {title}
          </h3>
        ...
        <div className="text-white mt-2 text-sm font-light">{body}</div>

        <div className="mt-3 flex justify-between items-center">
          <div className="flex gap-2">{stepsElem}</div>
          <div className="flex gap-2">
            <button
              className="p-2 px-3 text-sm rounded-lg text-white"
              onClick={handlePreviousSkip}
            >
              {previous && "Previous"} {!previous && "Skip"}
            </button>
            <button
              className="bg-white p-2 px-3 text-sm rounded-lg text-primary_700"
