...
function DevicesPage() {
  ...
  return (
    <div className="flex-1 flex">
      ...
      /> */}
      <div className="flex gap-5 mt-3 w-full max-w-[900px]">
          ...
          <div className="p-4">
            <div className="flex gap-2 mt-2 px-3 pb-2">
              ...
              <div className="flex gap-4 flex-1 ">
                <div className="text-sm w-[150px]">IMEI 1</div>
                <div className="text-sm w-[150px]">IMEI 2</div>
                <div className="text-sm w-[150px]">Date Configured</div>
            ...
            {devices.map((device) => {
              ...
              return (
                <div
                  className="flex gap-2 mt-2 px-3 py-3 border border-neutral_300 rounded-xl items-center"
                  key={device.imei1}
                >
                  <input type="checkbox" />
                  <div className="flex gap-4 flex-1 items-center">
                    ...
                    <div className="text-sm w-[150px]">{device.imei2}</div>
                    ...
                    <div className="text-sm w-[150px] ">
                      <Link
                        ...
                        className="p-2 bg-primary_700 rounded-xl text-sm text-white transition duration-500 
