  ...
  return (
    <div className="flex gap-4 min-h-[400px]">
      <div className="border border-neutral_300 py-3 px-4 flex-1 rounded-xl">
        ...
        <p className="font-light text-sm 2xl:text-base text-neutral_500">
          Update you company’s profile and contact details
        </p>

        <div className="mt-3">
          <div className="my-6">
            <p className="mb-3 text-sm 2xl:text-base">Business Logo</p>
            <div className="flex gap-3 items-center">
              ...
              />
              <div>
                <button className="text-sm 2xl:text-base text-primary_700 bg-primary_100 py-3 px-4 rounded-lg ">
                  Upload Image
                </button>
              </div>
            </div>
          ...
          <form className="flex flex-col gap-2">
            <div>
              <label className="text-sm 2xl:text-base">Business Name</label>
              <input
            ...
            <div>
              ...
              <input
                ...
                text-sm 2xl:text-base w-full border rounded-xl p-2 placeholder:font-light"
                type="text"
                placeholder="No 1, Flutterwave Street, Lagos, Nigeria"
              />
            </div>
            <div className="text-right">
              <button className="text-white 2xl:text-[1.15rem] bg-primary_700 p-2 px-4 rounded-xl">
                Save
              </button>
            </div>
          </form>
      ...
      <div className="flex-1 border border-neutral_300 py-3 px-4 rounded-xl">
        ...
        <p className="font-light text-sm 2xl:text-base text-neutral_500 flex-1">
          Update you company’s profile and contact details
        </p>
        <div className="mt-3">
          <div className="my-6">
            <p className="mb-3 text-sm 2xl:text-base">Profile Picture</p>
            <div className="flex gap-3 items-center">
              <Image
                src="/assets/vendor/register/photo.svg"
                width={80}
